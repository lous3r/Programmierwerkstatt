...
if(isset($_POST["Submit"]))
{
    ...
    {
        global $Connectingdb;
        $Query = "INSERT INTO admin_panel (datetime, title, category, location, author, image, post) VALUES ('$DateTime', '$Title', '$Category', '$Location', '$Admin', '$Image', '$Post')";
    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <span class="title-dashboard">Add New Post</span>
                    <?php
                        echo Message();
                        echo SuccessMessage();
                    ?>
