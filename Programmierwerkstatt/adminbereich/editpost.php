    ...
    <body>
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-sm-10">
                    <span class="title-dashboard">Update Post</span>
                    <?php
                        echo Message();
                        echo SuccessMessage();
                    ?>   
                    <div class="form">
                        <?php
                                    $SearchQueryParameter=$_GET['Edit']; //To search id by using superglobal $_GET
                                    $Connectingdb;
                        ...
                        <form action="editpost.php?Edit=<?php echo $SearchQueryParameter; ?>" method="post" enctype="multipart/form-data"> <!-- to succssessfully updated to dashboard -->
                            <fieldset>
                                ...
                                <div class="form-group">
                                    <span class="FieldInfo">Existing Location:</span>
                                    <?php echo $LocationToBeUpdated ?>
                                    <br/>
                                    <label for="locationselect"><span class="FieldInfo">Location:</span></label> <select class="form-control" id="locationselect" name="Location">
                                         <?php 
                                            global $Connectingdb;
                                            /*
                                            ...
                                            */
                                            ...
                                            while($DataRows=mysql_fetch_array($Execute)){
                                                $Id=$DataRows["id"];
                                                $LocationName=$DataRows["name"];
                                        
                                            ?>
                                        <option><?php echo $LocationName; ?></option>
                                        <?php } ?>
                                        </select>
                                </div>
                                <div class="form-group">
                                    ...
                                    <br/>
                                    <label for="categoryselect"><span class="FieldInfo">Category:</span></label> <select class="form-control" id="categoryselect" name="Category">
                                        <?php 
                                                    global $Connectingdb;
                                                    /*
                                                    without ORDER BY desc, the data will show in ascending, 
